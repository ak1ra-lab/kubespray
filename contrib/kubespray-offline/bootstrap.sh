...
latest_release="${bootstrap_dir}/latest_release.json"
kubespray_offline_dir="${bootstrap_dir}/kubespray-offline"

kubespray_offline_bootstrap() {
    cd "${bootstrap_dir}" || return
    ...
    cd "${kubespray_offline_dir}" || return
    ...
    cd "${kubespray_offline_dir}/src" || return
